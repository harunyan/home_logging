    ...
    async function fetchData() {
      try {
        const fetchLimit = (currentRangeMinutes >= 10080 || currentRangeMinutes === 0) ? 10000 : 5000;
    ...
    function setGraphRange(minutes) {
      const prevRange = currentRangeMinutes;
      ...
      if ((minutes >= 10080 || minutes === 0) && rawEventsData.length < 5000) {
        fetchData();
      } else {
        renderChart();
      }
